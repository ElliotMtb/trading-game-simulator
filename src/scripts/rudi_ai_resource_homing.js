...
app.AiResourceHoming = (function() {
    ...
    function intersectionsOfInterest(eligible, hexType) {

        var vertManager = app.Proxies.BoardVertices();
    ...
    function aIPlaceSettlement(playerProxy) {
        ...
        var priority = ['rock', 'wheat', 'wood', 'brick', 'sheep'];
